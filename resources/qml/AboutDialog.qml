...
UM.Dialog
{
    ...
    //: About dialog title
    title: catalog.i18nc("@title:window","About Continuum")
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","Continuum is developed by Sharebot in cooperation with the community.\nContinuum proudly uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
